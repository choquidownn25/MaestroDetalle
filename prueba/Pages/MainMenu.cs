...
namespace coderush.Pages
{
    public static class MainMenu
    {
        ...
        {
            public const string PageName = "Prueba Rest";
            public const string RoleName = "Prueba Rest";
            public const string Path = "/Prueba/Index";
            public const string ControllerName = "Prueba";
            public const string ActionName = "Index";
        }
